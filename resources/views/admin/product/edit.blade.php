                                ...
                                <div class="mb-3">
                                    ...
                                    <fieldset class="form-group">
                                        <select class="form-select @error('kategori') is-invalid @enderror" id="basicSelect"
                                            ...
                                            <option {{ $data->kategori == 'pants' ? 'selected' : '' }} value="pants">
                                                Pants</option>
                                            <option {{ $data->kategori == 'shirts' ? 'selected' : '' }} value="shirts">
                                                Shirts
                                            </option>
                                            <option {{ $data->kategori == 't-shirts' ? 'selected' : '' }} value="t-shirts">
                                                T-Shirts</option>
                                            <option {{ $data->kategori == 'jacket' ? 'selected' : '' }} value="jacket">
                                                jacket</option>
                                            <option {{ $data->kategori == 'outerwear' ? 'selected' : '' }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <fieldset class="form-group">
                                        <select class="form-select @error('size') is-invalid @enderror" id="basicSelect"
                                            ...
                                            <option {{ $data->size == 'S' ? 'selected' : '' }} value="S">
                                                Small (S)</option>
                                            <option {{ $data->size == 'M' ? 'selected' : '' }} value="M">Medium (M)
                                            </option>
                                            <option {{ $data->size == 'L' ? 'selected' : '' }} value="L">Large (L)
                                            </option>
                                            <option {{ $data->size == 'XL' ? 'selected' : '' }} value="XL">Extra Large
                                                (XL)</option>
                                        </select>
                                        @error('size')
                                            <span class="invalid-feedback" role="alert">
